	...
	g_ImGUI->NewFrame([]()
		{
			...
			ImGui::SliderFloat("RTAO Radius", &gOptions.AORadius, 0.0f, 150.0f);
			...
			ImGui::SliderFloat("GaussianKernelSigma", &gOptions.GaussianKernelSigma, 0.1f, 30.0f);
			ImGui::SliderFloat("BilateralKernelSigma", &gOptions.BilateralKernelSigma, 0.001f, 0.1f);
			...
			if (ImGui::BeginCombo("AOResolution(%)", gOptions.UseResolution, ImGuiComboFlags_None))
			{

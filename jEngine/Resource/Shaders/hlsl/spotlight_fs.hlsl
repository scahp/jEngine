...
cbuffer SpotLight : register(b0, space1) { jSpotLightUniformBufferData SpotLight; }
Texture2D SpotLightShadowMap : register(t1, space1);
SamplerComparisonState SpotLightShadowMapSampler : register(s1, space1);

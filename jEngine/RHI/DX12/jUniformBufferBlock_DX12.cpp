...
void jUniformBufferBlock_DX12::Init(size_t size)
{
    ...
    {
        BufferPtr = jBufferUtil_DX12::CreateBuffer(size, D3D12_CONSTANT_BUFFER_DATA_PLACEMENT_ALIGNMENT, EBufferCreateFlag::CPUAccess, EResourceLayout::READ_ONLY, nullptr, 0, jNameStatic("UniformBufferBlock"));

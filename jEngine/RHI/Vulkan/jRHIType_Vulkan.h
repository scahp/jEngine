...
GENERATE_CONVERSION_FUNCTION(GetVulkanTextureFormat,
    ...
    CONVERSION_TYPE_ELEMENT(ETextureFormat::R10G10B10A2, VK_FORMAT_A2R10G10B10_UNORM_PACK32),
    ...
    CONVERSION_TYPE_ELEMENT(ETextureFormat::R16UI, VK_FORMAT_R16_UINT),
...
FORCEINLINE auto GetVulkanTexturePixelSize(ETextureFormat type)
{
    GENERATE_STATIC_CONVERSION_ARRAY(
        CONVERSION_TYPE_ELEMENT(ETextureFormat::RGB8, 3),
...
FORCEINLINE VkDescriptorType GetVulkanShaderBindingType(EShaderBindingType InType)
{
    switch (InType)
    {
    case EShaderBindingType::UNIFORMBUFFER:                             return VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER;
    case EShaderBindingType::UNIFORMBUFFER_DYNAMIC:                     return VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC;
    case EShaderBindingType::TEXTURE_SAMPLER_SRV:                       return VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER;
    case EShaderBindingType::TEXTURE_SRV:                               return VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE;
    case EShaderBindingType::TEXTURE_UAV:                               return VK_DESCRIPTOR_TYPE_STORAGE_IMAGE;
    case EShaderBindingType::TEXTURE_ARRAY_SRV:                         return VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE;
    case EShaderBindingType::SAMPLER:                                   return VK_DESCRIPTOR_TYPE_SAMPLER;
    case EShaderBindingType::BUFFER_SRV:                                return VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    case EShaderBindingType::BUFFER_UAV:                                return VK_DESCRIPTOR_TYPE_STORAGE_BUFFER;
    case EShaderBindingType::BUFFER_UAV_DYNAMIC:                        return VK_DESCRIPTOR_TYPE_STORAGE_BUFFER_DYNAMIC;
    case EShaderBindingType::BUFFER_TEXEL_SRV:                          return VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER;
    case EShaderBindingType::BUFFER_TEXEL_UAV:                          return VK_DESCRIPTOR_TYPE_STORAGE_TEXEL_BUFFER;
    case EShaderBindingType::ACCELERATION_STRUCTURE_SRV:                return VK_DESCRIPTOR_TYPE_ACCELERATION_STRUCTURE_KHR;
    case EShaderBindingType::SUBPASS_INPUT_ATTACHMENT:                  return VK_DESCRIPTOR_TYPE_INPUT_ATTACHMENT;
    default:
        check(0);
        break;
    }

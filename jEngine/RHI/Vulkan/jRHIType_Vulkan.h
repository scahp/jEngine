...
GENERATE_CONVERSION_FUNCTION(GetVulkanShaderBindingType,
    ...
    CONVERSION_TYPE_ELEMENT(EShaderBindingType::UNIFORMBUFFER_DYNAMIC, VK_DESCRIPTOR_TYPE_UNIFORM_BUFFER_DYNAMIC),
    ...
    CONVERSION_TYPE_ELEMENT(EShaderBindingType::TEXTURE_ARRAY_SRV, VK_DESCRIPTOR_TYPE_SAMPLED_IMAGE),
    CONVERSION_TYPE_ELEMENT(EShaderBindingType::SAMPLER, VK_DESCRIPTOR_TYPE_SAMPLER),
    CONVERSION_TYPE_ELEMENT(EShaderBindingType::BUFFER_SRV, VK_DESCRIPTOR_TYPE_STORAGE_BUFFER),

...
#if (JPROFILE_BACKEND == JPROFILE_BACKEND_TRACY || JPROFILE_BACKEND == JPROFILE_BACKEND_OPTICK) && !JPROFILE_EXTERNAL_CPU_AVAILABLE
...
#elif JPROFILE_BACKEND == JPROFILE_BACKEND_OPTICK && JPROFILE_EXTERNAL_CPU_AVAILABLE
	#define JPROFILE_EXTERNAL_CPU_SCOPE_LITERAL(NameLiteral) OPTICK_EVENT(NameLiteral)
	#define JPROFILE_EXTERNAL_CPU_SCOPE_DYNAMIC_CSTR(NameCStr) OPTICK_EVENT(NameCStr)
#else
